...
| `python check_browser_smoke.py` | Runtime smoke test for module load, OBJ load, world stats, sidebar controls, and crash overlay |
...
- Playwright browser smoke coverage for runtime module/load and sidebar-control regressions
