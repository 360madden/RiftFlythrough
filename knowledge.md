...
6. `check_browser_smoke.py` is the CI/runtime gate for module load, OBJ load, stats, safe sidebar interactions, strict texture fixtures, startup-off texture behavior, persisted startup-setting probes, and retained smoke artifacts.
